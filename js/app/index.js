...
// app/logo.svg
var logo_default = "/myrepo/img/logo-4MXEBDEU.svg"         ;
...
var AppComponent = class extends ImbaElement {
  render() {
    ...
    (!cmpB$1 || cmpD$1 & 2) && cmpT$1.flagSelf$("vh-af");
    cmpB$1 || (headerT$1 = createElement("header", cmpT$1, `vh-ag ${sys$24}`, null));
    cmpB$1 || (svgT$1 = createSVGElement("svg", headerT$1, `vh-ah ${sys$24}`, null));
    cmpB$1 || svgT$1.set$("src", logo_default2);
    (pT$1 = cmpT$1[sys$44]) || (cmpT$1[sys$44] = pT$1 = createElement("p", headerT$1, `vh-aj ${sys$24}`, null));
    cmpB$1 || pT$1.insert$("Edit ");
    cmpB$1 || (codeT$1 = createElement("code", pT$1, `vh-ak ${sys$24}`, "app/index.imba"));
    cmpB$1 || pT$1.insert$(" and save to reload");
    cmpB$1 || (aT$1 = createElement("a", headerT$1, `vh-al ${sys$24}`, "Learn Imba"));
...
mount((appT$1 = createComponent("app", null, "vh-am", null), appB$1 || !appT$1.setup || appT$1.setup(appD$1), appT$1.end$(appD$1), appT$1));
//__FOOT__
//# sourceMappingURL=/myrepo/js/app/index.js.map
